                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-12" style="color: black;">{{ __('E-Mail Address') }}</label>

                            <div class="col-md-12">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus style="border-color: black;">
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-12" style="color: black;">{{ __('Password') }}</label>
                            <div class="col-md-12">
